...
namespace Dcat\Admin {
     ...
     * @property Grid\Column|Collection screenshot
     ...
     * @method Grid\Column|Collection screenshot(string $label = null)
     ...
     * @property Show\Field|Collection screenshot
     ...
     * @method Show\Field|Collection screenshot(string $label = null)
